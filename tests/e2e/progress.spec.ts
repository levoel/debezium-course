...
// Note: Progress migration tests use native Playwright test (not error-tracking fixture)
// because manipulating localStorage before hydration intentionally causes React hydration
// mismatches. This is expected behavior when testing localStorage migration logic.
